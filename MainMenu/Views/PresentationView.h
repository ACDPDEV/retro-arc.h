...
namespace MainMenu {
    inline void PresentationView() {
        const std::array<std::string, 9> title = Common::ConcatFont({Common::FONT9_R, Common::FONT9_E, Common::FONT9_T, Common::FONT9_R, Common::FONT9_O, Common::FONT9_A, Common::FONT9_R, Common::FONT9_C, Common::FONT9_DOT, Common::FONT9_H}, 2);
