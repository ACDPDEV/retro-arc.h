// Glifos Unicode para graficador TUI: bloques de relleno + caracteres de borde
// Pensado para usarse junto a EnableUTF8() (UTF-8)
// IMPORTANTE: guardar este archivo como UTF-8. Si compilás con MSVC (cl.exe),
// agregar el flag /utf-8 para que los literales se interpreten correctamente.
#pragma once
#include <array>
#include <string>
...
const array<string, 16> QUADRANTS = {
    ...
    "\u2598",   // 0001 ▘ sup-izq
    "\u259D",   // 0010 ▝ sup-der
    "\u2580",   // 0011 ▀ superior completo
    "\u2596",   // 0100 ▖ inf-izq
    "\u258C",   // 0101 ▌ izquierda completa
    "\u259E",   // 0110 ▞ diagonal (sup-der + inf-izq)
    "\u259B",   // 0111 ▛ todo menos inf-der
    "\u2597",   // 1000 ▗ inf-der
    "\u259A",   // 1001 ▚ diagonal inversa (sup-izq + inf-der)
    "\u2590",   // 1010 ▐ derecha completa
    "\u259C",   // 1011 ▜ todo menos inf-izq
    "\u2584",   // 1100 ▄ inferior completo
    "\u2599",   // 1101 ▙ todo menos sup-der
    "\u259F",   // 1110 ▟ todo menos sup-izq
    "\u2588"    // 1111 █ completo
};
