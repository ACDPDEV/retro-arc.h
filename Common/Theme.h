...
namespace Common
{
    ...
    const std::array<int, 3> BACKGROUND = {51, 54, 64};
    
    /// @brief Color de primer plano / texto principal (#bebebe)
    const std::array<int, 3> FOREGROUND = {190, 190, 190};
    ...
    const std::array<int, 3> SELECTION_BACKGROUND = {81, 81, 81};
    ...
    const std::array<int, 3> COLOR0 = {51, 51, 51};
    
    /// @brief Color 1: Rojo (#D35F5F)
    const std::array<int, 3> COLOR1 = {211, 95, 95};
    
    /// @brief Color 2: Amarillo/Verde (#FFC107)
    const std::array<int, 3> COLOR2 = {255, 193, 7};
    
    /// @brief Color 3: Rojo oscuro (#b91c1c)
    const std::array<int, 3> COLOR3 = {185, 28, 28};
    
    /// @brief Color 4: Naranja/Acento (#e68e0d)
    const std::array<int, 3> COLOR4 = {230, 142, 13};
    
    /// @brief Color 5: Magenta/Rojo (#D35F5F)
    const std::array<int, 3> COLOR5 = {211, 95, 95};
    
    /// @brief Color 6: Cian/Blanco suave (#bebebe)
    const std::array<int, 3> COLOR6 = {190, 190, 190};
    
    /// @brief Color 7: Blanco (#bebebe)
    const std::array<int, 3> COLOR7 = {190, 190, 190};
    
    // Bright colors (8-15) - ANSI bright variants
    /// @brief Color 8: Gris medio (#8a8a8d)
    const std::array<int, 3> COLOR8 = {138, 138, 141};
    
    /// @brief Color 9: Rojo brillante (#B91C1C)
    const std::array<int, 3> COLOR9 = {185, 28, 28};
    
    /// @brief Color 10: Amarillo brillante (#FFC107)
    const std::array<int, 3> COLOR10 = {255, 193, 7};
    
    /// @brief Color 11: Rojo muy oscuro (#b90a0a)
    const std::array<int, 3> COLOR11 = {185, 10, 10};
    
    /// @brief Color 12: Naranja brillante (#f59e0b)
    const std::array<int, 3> COLOR12 = {245, 158, 11};
    
    /// @brief Color 13: Rojo brillante (#B91C1C)
    const std::array<int, 3> COLOR13 = {185, 28, 28};
    
    /// @brief Color 14: Blanco suave (#eaeaea)
    const std::array<int, 3> COLOR14 = {234, 234, 234};
    
    /// @brief Color 15: Blanco puro (#ffffff)
    const std::array<int, 3> COLOR15 = {255, 255, 255};
}
